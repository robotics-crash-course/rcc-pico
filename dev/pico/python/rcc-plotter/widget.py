...
class Widget(QWidget):
    ...
    def __init__(self):
        ...
        self.data_line = self.plotter.plot()
        self.plotter.setYRange(-100, 100, padding=0)
    ...
    def add_data(self, data:Sensor_Data):
        ...
        self.ydata.append(data.angVelZ)

    def update_plot(self):
        print(f"Plot: {self.i}")
        self.i = self.i + 1
        self.data_line.setData(self.xdata[-100:], self.ydata[-100:])
